    ...
    v(window).on("load", function () {
        ...
        jQuery(document).ready(function () {
            ...
            objectFitImages(),
				...
				(function () {
                    var e = v(".related-slider3");
                    if (e.length) {
                        var i = v(".related-slider__nav3 .slider__prev"),
                            s = v(".related-slider__nav3 .slider__next");
                        e.slick({
                            slidesToShow: 4,
                            slidesToScroll: 1,
                            prevArrow: i,
				...
				(function () {
                    var e = v(".related-slider-top");
                    if (e.length) {
                        var i = v(".related-slider__navtop .slider__prev"),
                            s = v(".related-slider__navtop .slider__next");
                        e.slick({
                            slidesToShow: 5,
                            slidesToScroll: 1,
                            prevArrow: i,
                ...
                (function () {
                    var e = v(".testimonials-slider--style-4");
                    if (e.length) {
