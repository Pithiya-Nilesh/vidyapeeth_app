...
def get_portal_programs(language):
	...
	"""
	if language:
		published_programs = frappe.get_all("Program", filters={"is_published": True, "language": language})
...
@frappe.whitelist()
def evaluate_quiz_correct(quiz_response, quiz_name, course, program, time_taken):
	import json
	...
	# true_ans, false_ans, no_ans = quiz.evaluate_correct(quiz_response, quiz_name)
	answers = quiz.evaluate_correct(quiz_response, quiz_name)
	# print(answers)
	if has_super_access():
		# return {"true_ans": true_ans, "false_ans": false_ans, "no_ans": no_ans}
...
def get_quiz(quiz_name, course):
	...
	return {
		"questions": questions,
		"activity": {"is_complete": False, "score": score, "result": result, "time_taken": time_taken},
		"is_time_bound": quiz.is_time_bound,
		"duration": quiz.duration,
	}
...
# 	# language1 = language
# 	# print("\n\n\n\n", language1, "\n\n\n\n\n\n")
# 	return frappe.msgprint('hello', language)
